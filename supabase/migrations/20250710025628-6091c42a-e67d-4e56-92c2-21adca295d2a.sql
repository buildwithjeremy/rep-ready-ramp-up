-- Phase 4: Seed the database with test data (corrected UUIDs)
...
INSERT INTO public.reps (trainer_id, full_name, email, phone, address, milestone, status, overall_progress, join_date, last_activity)
VALUES
('6f5e4ec9-ff20-4eab-a1db-3edc3db3723a', 'John Smith', 'john.smith@email.com', '(555) 123-4567', '123 Main St, Anytown, ST 12345', 3, 'Active', 30, '2024-01-15', now() - interval '2 days'),
('6f5e4ec9-ff20-4eab-a1db-3edc3db3723a', 'Jane Doe', 'jane.doe@email.com', '(555) 234-5678', '456 Oak Ave, Somewhere, ST 67890', 7, 'Active', 70, '2024-02-20', now() - interval '1 day'),
('6f5e4ec9-ff20-4eab-a1db-3edc3db3723a', 'Bob Johnson', 'bob.johnson@email.com', '(555) 345-6789', '789 Pine St, Elsewhere, ST 13579', 10, 'Independent', 100, '2023-12-10', now() - interval '7 days'),
('6f5e4ec9-ff20-4eab-a1db-3edc3db3723a', 'Alice Brown', 'alice.brown@email.com', '(555) 456-7890', '321 Elm St, Nowhere, ST 24680', 5, 'Active', 50, '2024-03-01', now() - interval '3 days'),
('6f5e4ec9-ff20-4eab-a1db-3edc3db3723a', 'Charlie Wilson', 'charlie.wilson@email.com', '(555) 567-8901', '654 Maple Ave, Anywhere, ST 97531', 2, 'Stuck', 20, '2024-01-20', now() - interval '5 days'),
('6f5e4ec9-ff20-4eab-a1db-3edc3db3723a', 'Diana Taylor', 'diana.taylor@email.com', '(555) 678-9012', '987 Cedar St, Someplace, ST 86420', 8, 'Active', 80, '2024-02-15', now() - interval '1 day'),
('6f5e4ec9-ff20-4eab-a1db-3edc3db3723a', 'Frank Miller', 'frank.miller@email.com', '(555) 789-0123', '147 Birch Ave, Nowhere, ST 75319', 10, 'Independent', 100, '2023-11-30', now() - interval '10 days'),
('6f5e4ec9-ff20-4eab-a1db-3edc3db3723a', 'Grace Davis', 'grace.davis@email.com', '(555) 890-1234', '258 Spruce St, Everywhere, ST 64208', 6, 'Active', 60, '2024-03-10', now() - interval '2 days');
