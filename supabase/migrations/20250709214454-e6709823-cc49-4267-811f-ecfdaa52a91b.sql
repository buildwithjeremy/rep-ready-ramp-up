-- Phase 4: Seed the database with test data
...
-- Insert test trainers (based on mock data)
...
VALUES
-- We'll use placeholder UUIDs for now since we don't have actual auth users yet
('11111111-1111-1111-1111-111111111111', 'Sarah Johnson', 'sarah.johnson@teamtenacious.com', 8, 5, 2, 1, 28.5, 85.0),
('22222222-2222-2222-2222-222222222222', 'Mike Chen', 'mike.chen@teamtenacious.com', 6, 4, 1, 1, 32.0, 75.0),
('33333333-3333-3333-3333-333333333333', 'Emily Rodriguez', 'emily.rodriguez@teamtenacious.com', 10, 7, 2, 1, 25.0, 90.0),
('44444444-4444-4444-4444-444444444444', 'David Wilson', 'david.wilson@teamtenacious.com', 5, 3, 2, 0, 30.0, 80.0);

-- Insert test reps (based on mock data)
...
VALUES
-- Sarah Johnson's reps
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'John Smith', 'john.smith@email.com', '(555) 123-4567', '123 Main St, Anytown, ST 12345', 3, 'Active', 30, '2024-01-15', now() - interval '2 days'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '11111111-1111-1111-1111-111111111111', 'Jane Doe', 'jane.doe@email.com', '(555) 234-5678', '456 Oak Ave, Somewhere, ST 67890', 7, 'Active', 70, '2024-02-20', now() - interval '1 day'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', '11111111-1111-1111-1111-111111111111', 'Bob Johnson', 'bob.johnson@email.com', '(555) 345-6789', '789 Pine St, Elsewhere, ST 13579', 10, 'Independent', 100, '2023-12-10', now() - interval '7 days'),

-- Mike Chen's reps  
('dddddddd-dddd-dddd-dddd-dddddddddddd', '22222222-2222-2222-2222-222222222222', 'Alice Brown', 'alice.brown@email.com', '(555) 456-7890', '321 Elm St, Nowhere, ST 24680', 5, 'Active', 50, '2024-03-01', now() - interval '3 days'),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '22222222-2222-2222-2222-222222222222', 'Charlie Wilson', 'charlie.wilson@email.com', '(555) 567-8901', '654 Maple Ave, Anywhere, ST 97531', 2, 'Stuck', 20, '2024-01-20', now() - interval '5 days'),

-- Emily Rodriguez's reps
('ffffffff-ffff-ffff-ffff-ffffffffffff', '33333333-3333-3333-3333-333333333333', 'Diana Taylor', 'diana.taylor@email.com', '(555) 678-9012', '987 Cedar St, Someplace, ST 86420', 8, 'Active', 80, '2024-02-15', now() - interval '1 day'),
('gggggggg-gggg-gggg-gggg-gggggggggggg', '33333333-3333-3333-3333-333333333333', 'Frank Miller', 'frank.miller@email.com', '(555) 789-0123', '147 Birch Ave, Nowhere, ST 75319', 10, 'Independent', 100, '2023-11-30', now() - interval '10 days'),

-- David Wilson's reps
('hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', '44444444-4444-4444-4444-444444444444', 'Grace Davis', 'grace.davis@email.com', '(555) 890-1234', '258 Spruce St, Everywhere, ST 64208', 6, 'Active', 60, '2024-03-10', now() - interval '2 days');
