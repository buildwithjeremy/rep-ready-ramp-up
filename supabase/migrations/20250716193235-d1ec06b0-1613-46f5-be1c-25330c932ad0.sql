-- Create function to handle new REP user creation
...
-- Create trigger for new REP users
DROP TRIGGER IF EXISTS on_rep_user_created ON public.profiles;
CREATE TRIGGER on_rep_user_created
  AFTER INSERT OR UPDATE ON public.profiles
  FOR EACH ROW
  EXECUTE FUNCTION public.handle_new_rep_user();